...
const emailRoute = (req, res) => {
  const { data } = req.body; // Here we have all excel data
...
const mailParams = (company_name, email_of_employees, role) => {
//   company_name, email_of_employees, role, name, yoe, subject
